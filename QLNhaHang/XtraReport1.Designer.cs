namespace QLNhaHang
{
	partial class XtraReport1
	{
		...
		private void InitializeComponent()
		{
			...
			this.colTenTP = new DevExpress.XtraReports.UI.XRTableCell();
			...
			this.QrEx = new DevExpress.XtraReports.UI.XRBarCode();
			...
			this.colSTT.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			...
			this.colSTT.Weight = 0.25872026842754409D;
			// 
			// colTenTP
			// 
			this.colTenTP.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.colTenTP.Name = "colTenTP";
			this.colTenTP.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			this.colTenTP.StylePriority.UseBorders = false;
			this.colTenTP.StylePriority.UsePadding = false;
			this.colTenTP.StylePriority.UseTextAlignment = false;
			this.colTenTP.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.colTenTP.Weight = 0.78379005807667357D;
			// 
			// colDVT
			// 
			this.colDVT.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.colDVT.Multiline = true;
			this.colDVT.Name = "colDVT";
			this.colDVT.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			this.colDVT.StylePriority.UseBorders = false;
			this.colDVT.StylePriority.UsePadding = false;
			...
			this.colDVT.Weight = 0.53792813392274519D;
			// 
			// colSL
			// 
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.colSL.Multiline = true;
			this.colSL.Name = "colSL";
			this.colSL.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			this.colSL.StylePriority.UseBorders = false;
			this.colSL.StylePriority.UsePadding = false;
			...
			this.colSL.Weight = 0.55362099987765712D;
			// 
			// colGT
			// 
			this.colGT.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.colGT.Name = "colGT";
			this.colGT.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			this.colGT.StylePriority.UseBorders = false;
			this.colGT.StylePriority.UsePadding = false;
			...
			this.colGT.TextFormatString = "{0}";
			this.colGT.Weight = 0.45057867877765251D;
			this.colGT.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.colGT_BeforePrint);
			// 
			// colTT
			// 
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
			this.colTT.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colTT.Name = "colTT";
			this.colTT.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 5, 0, 100F);
			this.colTT.StylePriority.UseBorders = false;
			this.colTT.StylePriority.UseFont = false;
			this.colTT.StylePriority.UseForeColor = false;
			this.colTT.StylePriority.UsePadding = false;
			...
			this.colTT.TextFormatString = "{0}";
			this.colTT.Weight = 0.6745517465125217D;
			this.colTT.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.colTT_BeforePrint);
			// 
			// TopMargin
			// 
			...
			// QrEx
			// 
			this.QrEx.AutoModule = true;
			this.QrEx.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.QrEx.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
			this.QrEx.Name = "QrEx";
			this.QrEx.Padding = new DevExpress.XtraPrinting.PaddingInfo(10, 10, 0, 0, 100F);
			this.QrEx.ShowText = false;
			this.QrEx.SizeF = new System.Drawing.SizeF(126.1902F, 111.0417F);
			this.QrEx.StylePriority.UseFont = false;
			qrCodeGenerator1.CompactionMode = DevExpress.XtraPrinting.BarCode.QRCodeCompactionMode.Byte;
			this.QrEx.Symbology = qrCodeGenerator1;
			// 
			// invoiceInfoTable
			// 
			this.invoiceInfoTable.LocationFloat = new DevExpress.Utils.PointFloat(126.1902F, 169.375F);
			...
			this.invoiceInfoTable.SizeF = new System.Drawing.SizeF(388.4868F, 79.16668F);
			...
			// invoiceLabel
			// 
			this.invoiceLabel.Font = new System.Drawing.Font("Times New Roman", 27.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.invoiceLabel.Text = "PHIẾU NHẬP HÀNG";
			this.invoiceLabel.TextAlignment = DevExpress.XtraPrinting.TextAlignment.BottomCenter;
			...
			this.GroupFooter1.HeightF = 38.4583F;
			...
			this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(402.1769F, 0F);
			this.xrLabel1.Multiline = true;
			this.xrLabel1.Name = "xrLabel1";
			this.xrLabel1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
			this.xrLabel1.SizeF = new System.Drawing.SizeF(246.8232F, 36.80846F);
			...
			this.totalTable.LocationFloat = new DevExpress.Utils.PointFloat(226.9069F, 0F);
			this.totalTable.Name = "totalTable";
			this.totalTable.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.totalRow});
			this.totalTable.SizeF = new System.Drawing.SizeF(175.27F, 36.48938F);
			...
			// totalCaption
			// 
			this.totalCaption.Font = new System.Drawing.Font("Times New Roman", 15.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.totalCaption.Weight = 1.2478109242023328D;
			// 
			// excelDataSource1
			// 
			this.excelDataSource1.FileName = "C:\\Users\\m0565dt\\Documents\\NH06_07-18-2024.xlsx";
			...
			excelWorksheetSettings1.WorksheetName = "dh";
			...
			// excelDataSource2
			// 
			this.excelDataSource2.FileName = "C:\\Users\\m0565dt\\Documents\\NH06_07-18-2024.xlsx";
			...
			excelWorksheetSettings2.WorksheetName = "table";
			...
			this.lineTotalCaption.Weight = 0.66506817077325642D;
			// 
			// unitPriceCaption
			// 
			...
			this.xrTableCell3.Weight = 0.545837564883724D;
			// 
			// xrTableCell1
			// 
			...
			this.xrTableCell1.Text = "Đơn vị tính";
			this.xrTableCell1.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell1.Weight = 0.53036530870492316D;
			// 
			// productNameCaption
			// 
			...
			this.productNameCaption.Text = "Tên thực phẩm";
            ...
            this.headerTable});
			this.GroupHeader1.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// excelDataSource3
			// 
			this.excelDataSource3.FileName = "C:\\Users\\m0565dt\\Documents\\NH06_07-18-2024.xlsx";
			...
			excelWorksheetSettings3.WorksheetName = "table";
			excelSourceOptions3.ImportSettings = excelWorksheetSettings3;
			excelSourceOptions3.SkipEmptyRows = false;
		...
		private DevExpress.XtraReports.UI.XRTableCell colTenTP;
		...
		private DevExpress.XtraReports.UI.XRBarCode QrEx;
